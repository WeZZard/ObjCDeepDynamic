...
// Makes fishhook visible outside the framework.
 ...
 */
#define onExit \
    _OBJCDD_KEYWORD_FUNCTION_SCOPE \
...
#define _OBJCDD_MODULE_CONSTRUCTOR_HIGH_PRIORITY __attribute__((constructor(101)))
#define _OBJCDD_MODULE_CONSTRUCTOR_LOW_PRIORITY __attribute__((constructor(65535)))

#define _OBJCDD_KEYWORD_FILE_SCOPE interface NSObject(\
        metamacro_concat(\
            metamacro_concat(\
                objcdd_dynamic_property_getter_garbage_interface,\
                _\
            ),\
            __LINE__\
        )\
...
// autorelease pools.
#if DEBUG
#define _OBJCDD_KEYWORD_FUNCTION_SCOPE autoreleasepool {}
#else
#define _OBJCDD_KEYWORD_FUNCTION_SCOPE try {} @catch (...) {}
#endif

typedef void (^ext_cleanupBlock_t)(void) NS_SWIFT_UNAVAILABLE("");

#if defined(__cplusplus)
extern "C" {
#endif
    void ext_executeCleanupBlock (__strong ext_cleanupBlock_t *block) NS_SWIFT_UNAVAILABLE("");
#if defined(__cplusplus)
}
#endif
